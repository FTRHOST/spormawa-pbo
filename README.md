...
1. 43050250031 ANDI KURNIAWAN (Spesialis Logika Bisnis)
2. 43050250010 MIFTAKHUL ANWAR (Perancang Arsitektur)
3. 43050250011 MUHAMMAD FATHIR AL FARUQ (Backend)
4. 43050250034 RIZKY ANGFAUZY (CLI Developer)
...
_Proyek ini dikembangkan untuk memenuhi tugas mata kuliah Pemrograman Berorientasi Objek (PBO)._
